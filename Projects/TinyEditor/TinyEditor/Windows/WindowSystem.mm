...
void WindowSystem::Update(GameObject gameObject, const Editor::Window &window, const Tiny::WorldTransform &worldTransform, const Tiny::Sizeable& sizeable) {
    ...
    if (editorWindow.needsUpdate) {
        ...
        Editor::Window* modifyWindow = (Editor::Window*)&window;
