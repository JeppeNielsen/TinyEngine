...
namespace Editor {
struct WindowDragCancelSystem : Tiny::System<Editor::Window, Tiny::Draggable, Tiny::Sizeable, Tiny::LocalTransform>,
Tiny::RemoveDependencies<WindowSystem, Tiny::DraggableSystem> //}, Tiny::WorldTransformSystem, Tiny::HierarchyWorldTransformSystem>
{
public:
    void Update(Editor::Window& window, Tiny::Draggable& draggable, Tiny::Sizeable& sizeable, Tiny::LocalTransform& localTransform);
};
}
