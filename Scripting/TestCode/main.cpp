...
int main() {
    ...
    context.hppFiles.push_back("/Jeppes/TinyEngine/Scripting/Source/Scripts/Vector2.hpp");
    context.cppFiles.push_back("/Jeppes/TinyEngine/Scripting/Source/Scripts/TestScript.txt");
    context.cppFiles.push_back("/Jeppes/TinyEngine/Scripting/Source/Scripts/TestScript2.txt");
